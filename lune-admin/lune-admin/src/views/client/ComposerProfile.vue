<template>
    <div>
        ...
        <div class="mainPage_up">
            <div class="mainHolder">
                <div class="textHolder">
                    <div class="avatar">
                        <img class = "avatar_img" src="https://s2.loli.net/2022/07/06/vTCbfJUOlsX3mKd.png" alt="">
                    </div>
        ...
        <div class="mainPage_down"><composer-info></composer-info></div>
...
import ComposerInfo from './ComposerInfo.vue'
export default {
  components: { clientHeader, PageFooter, ComposerInfo },
  data () {
    return {
...
.mainHolder {
  ...
  width: 100%;
  height: 400px;
  background-image: url(https://s2.loli.net/2022/07/06/vTCbfJUOlsX3mKd.png);
